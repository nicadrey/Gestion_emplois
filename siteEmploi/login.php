			...
			<div class="container clearfix">
				...
				<div class="extra-nav">
					<div class="extra-cell">
						<a href="register.html" class="site-button"><i class="fa fa-user"></i> S'inscrire</a>
						<a href="coming-soon.html" class="site-button"><i class="fa fa-lock"></i>Connexion</a>
				...
				<div class="header-nav navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
					<ul class="nav navbar-nav">
						<li >
							<a href="index-2.html">JobBoard</a>
							
						</li>
						<li >
							<a href="about-us.html">A propos</a>
							<!--<ul class="sub-menu">
								<li><a href="about-us.html" class="dez-page"></a></li>
						...
						<li>
							<a href="#">Chercheurs<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
								<li><a href="OffresDispo.html" class="dez-page">Visiter les offres</a></li>
								<li><a href="companies.html" class="dez-page">entreprises</a></li>
								<li><a href="job-detail.html" class="dez-page">Offres détaillées </a></li>
							</ul>
						</li>
						<li>
							<a href="#">entreprises <i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
								<li><a href="browse-candidates.html" class="dez-page">Consulter les profils</a></li>
								<li><a href="s'inscrire.html" class="dez-page">S'inscrire</a></li>
							</ul>
						</li>
						...
						<div class="p-a30 border-1 seth">
							<div class="tab-content nav">
								<form id="login" class="tab-pane active col-12 p-a0 ">
									<h4 class="font-weight-700">Formulaire de Connexion</h4>
									<p class="font-weight-600">
										Si vous avez un compte chez nous, veuillez vous connecter.</p>
									<div class="form-group">
										<label class="font-weight-700">NOM DE L'ENTREPRISE*</label>
										<input name="dzName" required="" class="form-control" placeholder="identifiant" type="email">
									</div>
									<div class="form-group">
										<label class="font-weight-700">MOT DE PASSE *</label>
										<input name="dzName" required="" class="form-control " placeholder="Mot de passe" type="password">
									</div>
									<div class="text-left">
										<a data-toggle="tab" class="site-button m-r5 button-lg" href="adminentreprise.php" class="m-l5">Connexion</a>
										<a data-toggle="tab" href="#forgot-password" class="m-l5"><i class="fa fa-unlock-alt"></i> mot de passe oublié</a> 
									</div>
								</form>
								<form id="forgot-password" class="tab-pane fade  col-12 p-a0">
									<h4 class="font-weight-700">VOUS AVEZ OUBLIE VOTRE MOT DE PASSE?</h4>
									...
									<div class="form-group">
										...
										<input name="dzName" required="" class="form-control" placeholder="Votre email" type="email">
									</div>
									<div class="text-left"> 
										<a class="site-button outline gray button-lg" data-toggle="tab" href="#login">Retour</a>
										<button class="site-button pull-right button-lg">Envoyer</button>
									</div>
								</form>
							</div>
						</div>
