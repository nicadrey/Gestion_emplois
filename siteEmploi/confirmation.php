        ...
        <div class="dez-bnr-inr overlay-black-middle bg-pt" style="background-image:url(images/banner/bnr2.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Merci de nous avoir contacté!!!</h1>
					
					<a href="index.php" class="site-button"><i class="fa fa-lock"></i>retourner à la page d'acceuil</a>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
					<div class="col-md-12 text-center">
						<h3 class="font-weight-700 m-t0 m-b20">Vos informations ont été bien enregistrées</h3>
					</div>
				</div>
